...
class BPR(IterativeRecommender):
    ...
    def buildModel_tf(self):
        ...
        # opt = tf.train.AdagradDAOptimizer(0.01)
        # opt = tf.train.ProximalGradientDescentOptimizer(0.01)
        # opt = tf.train.ProximalAdagradOptimizer(0.01)
    ...
    def predictForRanking(self, u):
        ...
        if self.data.containsUser(u):
            ...
            #print (self.Q.dot(self.P[u])).size
            #print('-------------------')
